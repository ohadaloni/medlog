...
class MedLog extends Mcontroller {
	...
	public function registration() {
		...
		$this->Mview->msg("Medlog is a tiny little robot that helps you control your med taking");
		$this->Mview->msg("Just tell it you took a med,");
		$this->Mview->msg("and it will tell you when it is due,");
		$this->Mview->msg("or missed! whichever the case may be");
		$this->Mview->msg("This only works after you took a med at least twice");
	}
	/*------------------------------------------------------------*/
